...
| --------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- | ---------- |
| **DEFINE**      | says what the word names, in their own words, nothing open in front of them      | the definition is right, and is neither the source's sentence reworded nor just another of its names | reception  |
...
learned. The three production moves each need something the learner brings: a distinction, an
error spotted, their own work.
...
**In review, prefer APPLY.** It draws on work that didn't exist when the word was first met,
so it can't be answered from memory of answering before. That's exactly the property a review
wants and the other moves don't have.
